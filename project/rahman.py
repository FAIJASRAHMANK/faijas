...
model_xgbbl = joblib.load('df_X (2).pkl')
...
if st.button("Predict"):
    ...
    prediction = model_xgbbl .predict(features_scaled)[0]
    if prediction == 1:
        st.success("✅ The client likely to subscribe to a term deposit.")
    else:
        st.warning("❌ The client  not likely to subscribe.")
